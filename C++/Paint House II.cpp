...
public:
    ...
    int minCostII(vector<vector<int>>& costs) {
        ...
        int first = 0;//Keep track of the best colour 
        int second = 1;//Keep track of second best colour
        for(int i = 0; i < k; ++i) {
            DP[0][i] = costs[0][i];
        ...
        for(int i = 1; i < n; ++i) {
            ...
            int tempFirst = 0;//Keep Track of the next best colour
            int tempSecond = 1;//Keep track of the next second best colour
            DP[ i%2 ][0] = INT_MAX;
            DP[ i%2 ][1] = INT_MAX;
